    ...
    <div className="relative overflow-hidden bg-amber-50 border border-amber-200 rounded-sm shadow-sm p-6 flex flex-col gap-5">
      ...
      <div className="flex items-start justify-between relative z-10">
        <div>
          ...
          <h3 className="font-cormorant text-2xl font-semibold text-stone-900 leading-tight">{team.name}</h3>
        </div>
        <div className="flex items-center gap-0.5 shrink-0 ml-2">
          <button onClick={onEdit} className="p-1.5 text-stone-500 hover:text-amber-600 transition-colors" title="Edit">
            <IconEdit />
          </button>
          {!confirmDelete ? (
            ...
            <div className="flex items-center gap-1 bg-red-50 border border-red-200 px-2 py-1 ml-1">
              ...
              <button onClick={() => onDelete(team.id)} className="p-0.5 text-red-500 hover:text-red-700"><IconCheck /></button>
      ...
      {team.description && (
        <p className="text-sm text-stone-700 leading-relaxed relative z-10 border-l-2 border-amber-500/55 pl-3">{team.description}</p>
      )}
            ...
            return (
              <div key={m.id} className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-sm text-stone-900 truncate font-cormorant font-medium">{userName(m)}</p>
